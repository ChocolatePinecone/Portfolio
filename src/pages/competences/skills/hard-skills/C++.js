    ...
    return (
        <div id='C++'>
            ...
            <p>
                ...
                <br/>
                The game is called <ContentLink href='/experience/projects/rocket-shipment'>Rocket Shipment</ContentLink> and has a <a target='_blank' rel="noopener noreferrer" href='https://store.steampowered.com/app/1237310/Rocket_Shipment/'>Steam page<OpenInNewIcon fontSize="small"/></a>!
            </p>
        </div>
    );
};
