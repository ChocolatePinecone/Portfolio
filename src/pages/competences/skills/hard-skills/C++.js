...
const Cplusplus = () => (
    <div id='C++'>
        ...
        <p>
            I&apos;ve hobbied with making video games and in July 2018 I really wanted to make a video game from scratch.
            I chose to do this with SFML and C++, which meant I needed to brush up on my C++ knowledge.
            I spent 1 or 2 weeks learning C++ with help of Pluralsight and pushed my first lines of code to the repo around August 1st.
        </p>
        <p>
