...
const Phaser = () => (
    <div id='phaser'>
        ...
        <p>
            ...
            It takes care of the more complicated stuff like game loops, input management, audio, physics, collision detection, animation, etc.
        </p>
        <p>
            I read about Phaser and first tried it out by making <strong>a Pong game</strong>.
        </p>
        <p>
            Because Phaser is so easy to use, you can set up a game very quickly and still learn some game development lessons in the process.
            Because of these strengths I decided to make a <ContentLink href='/experience/projects/my-phaser-workshop'>workshop about game development</ContentLink> with it.
        </p>
        <p>
