...
const Phaser = () => {
    return (
        <div id='phaser'>
            ...
            <p>
                I read about Phaser and first tried it out by making <strong>a Pong game, which you can play below!</strong>
            </p>
            <p>
            ...
            <p>
                Game development is a big hobby of mine! if you're interested, check out my self made game <ContentLink href='/experience/projects/rocket-shipment'>Rocket Shipment</ContentLink> and its <a target='_blank' href='https://store.steampowered.com/app/1237310/Rocket_Shipment/'>Steam page<OpenInNewIcon fontSize="small"/></a>.
            </p>
        </div>
    );
};
