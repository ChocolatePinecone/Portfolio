...
const Polymer = () => (
    <div id='polymer'>
        ...
        <p>
            ...
            The Shadow DOM keeps components contained and shielded from everything outside it, which makes it hard to check or set certain values while running tests.
        </p>
        <p>
